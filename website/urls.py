...
urlpatterns = patterns('website.views',
    ...
    # url(r'^system/', include('academy.urls')),
    ...
    url(r'^my-student-list', WebsiteStudentList.as_view(), name="my-student-list"),
    url(r'^my-student-detail/(?P<pk>\d+)', WebsiteStudentDetail.as_view(), name="my-student-detail"),
