...
urlpatterns = patterns('website.views',
    ...
    url(r'^adult-course$', TemplateView.as_view(template_name="template_website/adult-course.html"),
        name="adult-course"),
    url(r'^gallery-add', EntryAdd.as_view(), name="gallery-add"),
    url(r'^entry-list$', EntryList.as_view(), name="entry-list"),
    url(r'^entry-add$', EntryAdd.as_view(), name="notice-add"),
    url(r'^notice-detail/(?P<pk>\d+)$', EntryDetail.as_view(), name="notice-detail"),
    url(r'^schedule', TemplateView.as_view(template_name="template_website/schedule.html"), name="schedule"),
    url(r'^communication', TemplateView.as_view(template_name="template_website/communication.html"), name="communication"),
