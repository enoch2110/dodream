...
urlpatterns = patterns('website.views',
    ...
    url(r'^adult-course$', TemplateView.as_view(template_name="template_website/adult-course.html"),
        name="adult-course"),
    url(r'^gallery', TemplateView.as_view(template_name="template_website/gallery-list.html"),
        name="gallery-list"),
    url(r'^gallery-add', EntryAdd.as_view(), name="gallery-add"),
    url(r'^reference', TemplateView.as_view(template_name="template_website/reference-list.html"),
        name="reference"),
