...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'academy_staff', (
            ...
            ('main_course', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('specs', self.gf('django.db.models.fields.TextField')(max_length=100)),
            ('registered_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 7, 8, 0, 0))),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, null=True, blank=True)),
        ))
        db.send_create_signal(u'academy', ['Staff'])


        # Changing field 'Course.syllabus'
        db.alter_column(u'academy_course', 'syllabus', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Course.price_info'
        db.alter_column(u'academy_course', 'price_info', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Course.syllabus'
        raise RuntimeError("Cannot reverse this migration. 'Course.syllabus' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Course.syllabus'
        db.alter_column(u'academy_course', 'syllabus', self.gf('django.db.models.fields.TextField')())

        # User chose to not deal with backwards NULL issues for 'Course.price_info'
        raise RuntimeError("Cannot reverse this migration. 'Course.price_info' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Course.price_info'
        db.alter_column(u'academy_course', 'price_info', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        u'academy.staff': {
            ...
            'main_course': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
