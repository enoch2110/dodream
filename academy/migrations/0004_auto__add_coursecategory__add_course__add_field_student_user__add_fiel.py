...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'academy_coursecategory', (
            ...
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['academy.CourseCategory'])),
        ))
        ...
        db.create_table(u'academy_course', (
            ...
            ('price_info', self.gf('django.db.models.fields.TextField')()),
            ('syllabus', self.gf('django.db.models.fields.TextField')()),
    ...
    models = {
        ...
        u'academy.coursecategory': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['academy.CourseCategory']"})
        },
        u'academy.guardian': {
