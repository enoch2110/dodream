...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CourseCategory.parent'
        db.alter_column(u'academy_coursecategory', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['academy.CourseCategory'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'CourseCategory.parent'
        raise RuntimeError("Cannot reverse this migration. 'CourseCategory.parent' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'CourseCategory.parent'
        db.alter_column(u'academy_coursecategory', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['academy.CourseCategory']))
    ...
    models = {
        u'academy.course': {
            ...
            'price_info': ('django.db.models.fields.TextField', [], {}),
            'syllabus': ('django.db.models.fields.TextField', [], {})
        },
        ...
        u'academy.student': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'registered_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 2, 0, 0)'}),
